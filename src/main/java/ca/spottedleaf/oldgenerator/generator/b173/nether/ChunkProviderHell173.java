...
public class ChunkProviderHell173 implements ChunkLoader, OldChunkGenerator {
    ...
    public ChunkProviderHell173(int minHeight, int maxHeight, long seed) {
        this.seed = seed;
    ...
    public void generateBareTerrain(int chunkX, int chunkZ, Block.Setter blockSetter) {
        byte b0 = 4;
        byte b1 = 32;
        int k = b0 + 1;
        byte b2 = 17;
                    ...
                    for (int l1 = 0; l1 < 8; ++l1) {
                        ...
                        for (int i2 = 0; i2 < 4; ++i2) {
                            ...
                            for (int k2 = 0; k2 < 4; ++k2) {
                                ...
                                LegacyUtil173.setBlockIndex(blockSetter, j2, l2);
                                j2 += short1;
                                d15 += d16;
                            }
    ...
    public void generateBiomeTerrain(int chunkX, int chunkZ, Block.Getter blockGetter, Block.Setter blockSetter) {
        byte b0 = 64;
        double d0 = 0.03125D;
    ...
    public void generateUnpopulatedChunkData(int chunkX, int chunkZ, Biome.Setter biomeSetter, Block.Getter blockGetter, Block.Setter blockSetter) {
        ...
        this.generateBareTerrain(chunkX, chunkZ, blockSetter);
        this.generateBiomeTerrain(chunkX, chunkZ, blockGetter, blockSetter);
        this.caveGenerator.generate(blockGetter, blockSetter, this.minHeight, this.maxHeight, this.seed, chunkX, chunkZ);

        for (int z = 0; z <= 15; ++z) {
            for (int x = 0; x <= 15; ++x) {
//                biomeSetter.setBiome(x, z, Biome.NETHER_WASTES); // TODO: this
            }
        }
    }
    ...
    public void populateChunk(int chunkX, int chunkZ, Block.Getter blockGetter, Block.Setter blockSetter) {
        ...
        for (i1 = 0; i1 < 8; ++i1) {
            ...
            (new WorldGenHellLava173(Block.LAVA)).populate(blockGetter, blockSetter, this.random, j1, k1, l1);
        }
        ...
        for (j1 = 0; j1 < i1; ++j1) {
            ...
            (new WorldGenFire173()).populate(blockGetter, blockSetter, this.random, k1, l1, i2);
        }
        ...
        for (j1 = 0; j1 < i1; ++j1) {
            ...
            l1 = (this.random.nextInt(120 - minHeight) + minHeight) + 4;
            i2 = l + this.random.nextInt(16) + 8;
            (new WorldGenLightStone2173()).populate(blockGetter, blockSetter, this.random, k1, l1, i2);
        }
        ...
        for (j1 = 0; j1 < 10; ++j1) {
            ...
            i2 = l + this.random.nextInt(16) + 8;
            (new WorldGenLightStone1173()).populate(blockGetter, blockSetter, this.random, k1, l1, i2);
        }
        ...
        if (this.random.nextInt(1) == 0) { // TODO: should this be really be bound 1?
            ...
            l1 = l + this.random.nextInt(16) + 8;
            (new WorldGenFlowers173(Block.BROWN_MUSHROOM, this.minHeight, this.maxHeight)).populate(blockGetter, blockSetter, this.random, j1, k1, l1);
        }
        ...
        if (this.random.nextInt(1) == 0) { // TODO: should this be really be bound 1?
            ...
            k1 = this.random.nextInt(maxHeight + 1 - minHeight) + minHeight;
            l1 = l + this.random.nextInt(16) + 8;
            (new WorldGenFlowers173(Block.RED_MUSHROOM, this.minHeight, this.maxHeight)).populate(blockGetter, blockSetter, this.random, j1, k1, l1);
        }
    }
